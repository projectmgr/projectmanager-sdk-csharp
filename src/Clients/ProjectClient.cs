...
namespace ProjectManager.SDK.Clients
{
    ...
    public class ProjectClient
    {
        ...
        public async Task<AstroResult<ProjectDto[]>> QueryProjects(string top = null, string skip = null, string filter = null, string select = null, string orderby = null, string expand = null)
        {
