...
namespace ProjectManager.SDK.Clients
{
    ...
    public class TaskFieldClient
    {
        ...
        public async Task<AstroResult<GetTaskFieldsResponseDtoListAstroResult>> RetrieveTaskFields(Guid projectId)
        {
            var url = $"/project-api/public/projects/{projectId}/tasks/fields";
            return await _client.Request<GetTaskFieldsResponseDtoListAstroResult>(HttpMethod.Get, url, null, null, null);
        }
        ...
        public async Task<AstroResult<ChangeSetStatusDtoAstroResult>> CreateTaskField(Guid projectId, CreateTaskFieldRequestDto body)
        {
            var url = $"/project-api/public/projects/{projectId}/tasks/fields";
        ...
        public async Task<AstroResult<AstroResult>> DeleteTaskField(Guid projectId, Guid fieldId)
        {
            var url = $"/project-api/public/projects/{projectId}/tasks/fields/{fieldId}";
            return await _client.Request<AstroResult>(HttpMethod.Delete, url, null, null, null);
        }
        ...
        public async Task<AstroResult<TaskFieldsValueResponseDtoAstroResult>> RetrieveTaskFieldValue(Guid taskId, Guid fieldId)
        {
            var url = $"/project-api/public/tasks/{taskId}/fields/{fieldId}";
            return await _client.Request<TaskFieldsValueResponseDtoAstroResult>(HttpMethod.Get, url, null, null, null);
        }
        ...
        public async Task<AstroResult<ChangeSetStatusDtoAstroResult>> UpdateTaskFieldValue(Guid taskId, Guid fieldId, UpdateTaskFieldValueDto body)
        {
            var url = $"/project-api/public/tasks/{taskId}/fields/{fieldId}";
        ...
        public async Task<AstroResult<TaskFieldsValueResponseDtoListAstroResult>> RetrieveAllTaskFieldValues(Guid taskId)
        {
            var url = $"/project-api/public/tasks/{taskId}/fields";
            return await _client.Request<TaskFieldsValueResponseDtoListAstroResult>(HttpMethod.Get, url, null, null, null);
        }
    }
}
