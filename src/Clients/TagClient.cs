...
namespace ProjectManager.SDK.Clients
{
    ...
    public class TagClient
    {
        ...
        public async Task<AstroResult<TagDtoListAstroResult>> QueryTags(string $top = null, string $skip = null, string $filter = null, string $select = null, string $orderby = null, string $expand = null)
        {
            ...
            return await _client.Request<TagDtoListAstroResult>(HttpMethod.Get, url, options, null, null);
        }
        ...
        public async Task<AstroResult<TagDtoAstroResult>> CreateTag(TagCreateDto body)
        {
            var url = $"/project-api/public/tags";
            return await _client.Request<TagDtoAstroResult>(HttpMethod.Post, url, null, body, null);
        }
    }
}
