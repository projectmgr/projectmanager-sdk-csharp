...
namespace ProjectManager.SDK.Clients
{
    ...
    public class WorkSpaceClient : IWorkSpaceClient
    {
        ...
        /// </summary>
        public async Task<AstroResult<WorkSpaceDto[]>> RetrieveCurrentWorkspace()
        {
        ...
        public async Task<AstroResult<WorkSpaceDto>> UpdateCurrentWorkspaceSettings(WorkspaceSettingsUpdateDto body)
        {
