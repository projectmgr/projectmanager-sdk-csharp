...
namespace ProjectManager.SDK.Clients
{
    ...
    public class TaskClient
    {
        ...
        public async Task<AstroResult<TaskDto[]>> QueryTasks(string top = null, string skip = null, string filter = null, string select = null, string orderby = null, string expand = null)
        {
