...
namespace ProjectManager.SDK.Clients
{
    ...
    public class TagClient
    {
        ...
        public async Task<AstroResult<TagDto[]>> QueryTags(string top = null, string skip = null, string filter = null, string select = null, string orderby = null, string expand = null)
        {
