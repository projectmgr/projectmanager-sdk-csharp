...
namespace ProjectManager.SDK.Clients
{
    ...
    public class ResourceSkillClient
    {
        ...
        /// </summary>
        public async Task<AstroResult<BusinessSkillDtoListAstroResult>> RetrieveResourceSkills()
        {
            var url = $"/project-api/public/resources/skills";
            return await _client.Request<BusinessSkillDtoListAstroResult>(HttpMethod.Get, url, null, null, null);
        }
    }
}
